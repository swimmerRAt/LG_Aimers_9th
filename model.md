...
| 공식 리더보드 | 현재 시간창 + 두 후단 보정 제출 | **799.58078** | 정답 평균 비공개로 역산 불가 |
| 공식 리더보드 | 위 모델 + 전역 logit `-0.02` | **835.33655** | 기준 대비 +35.75577점 |
| 공식 리더보드 | 위 모델 + 전역 logit `-0.04` | **851.27137** | 기준 대비 +51.69058점 |
| 공식 리더보드 | 위 모델 + 전역 logit `-0.0461` | **852.19850** | 기준 대비 +52.61772점 |
